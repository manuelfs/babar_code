...
#include "EvtGenModels/Evt2HDMFF.hh"
...
Evt2HDMFF::Evt2HDMFF(double tBmH) {
...
void Evt2HDMFF::getscalarff(EvtId parent,EvtId daught,
  ...
  if (daught==A00||daught==A0P||daught==A0M||daught==F0||
      ...
      daught==K0ST0) {
    Evt2HDMFF3P0(parent,daught,t,mass,fpf,&fmf);
  }

  double mb_quark = 4.20;  // [GeV] in the MSbar scheme, evaluated at mb. 
  double mc_quark = 0.901; // From Xing, Zhang, Zhou (2008)

  *f0f = ((fmf/((mb*mb-mass*mass)/t))+(*fpf))*(1-pow(_tBmH,2)*t/(1-mc_quark/mb_quark));

  return ;
}

 void Evt2HDMFF::gettensorff(EvtId parent,EvtId daught,
  ...
  static EvtId BS0=EvtPDL::getId("B_s0");
    ...
    Evt2HDMFF3P2(parent,daught,t,mass,hf,kf,bpf,bmf);
 ...
 void Evt2HDMFF::getvectorff(EvtId parent,EvtId daught,
  ...
  static EvtId BS0=EvtPDL::getId("B_s0");
   ...
   if (daught==DST0||daught==DSTP||daught==DSTM||daught==DSTB||
     ...
     Evt2HDMFF3S1(parent,daught,t,mass,&ff,&gf,&apf,&amf);
   }
   ...
   if (daught==A10||daught==A1P||daught==A1M||daught==F1||
       ...
       daught==K1ST0) {
     Evt2HDMFF3P1(parent,daught,t,mass,&ff,&gf,&apf,&amf);
   }
  ...
  *a0f = (a3f + ( (t*amf)/(2.0*mass)))*(1-pow(_tBmH,2)*t/(1+mc_quark/mb_quark));
...
void Evt2HDMFF::Evt2HDMFF1S0 (EvtId parent,EvtId daugt,
...
void  Evt2HDMFF::Evt2HDMFF3S1(EvtId parent,EvtId daugt,double t,double mass,
  ...
  if (parent==B0||parent==B0B||parent==BP||parent==BM) {
	...
	report(ERROR,"EvtGen") << "Not implemented parent in get_thdm_ff_3S1.\n";
      }
    }
    }
  }
...
void Evt2HDMFF::Evt2HDMFF21S0 (EvtId parent,EvtId daugt,
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	nfp=3.0;
      ...
      report(ERROR,"EvtGen") << "Not implemented daugt in get_Evt2HDM_ff_21S0.\n";
      }
    }
  }
  else{
	...
	report(ERROR,"EvtGen") << "Not implemented daugt in get_Evt2HDM_ff_21S0.\n";
      ...
      report(ERROR,"EvtGen") << "Not implemented parent in get_Evt2HDM_ff_21S0.\n";
    }
  }
...
void Evt2HDMFF::Evt2HDMFF23S1 (EvtId parent,EvtId daugt,
...
void Evt2HDMFF::Evt2HDMFF1P1 (EvtId parent,EvtId daugt,
...
void Evt2HDMFF::Evt2HDMFF3P1 (EvtId parent,EvtId daugt, 
...
void Evt2HDMFF::Evt2HDMFF3P0 (EvtId parent,EvtId daugt,
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	report(ERROR,"EvtGen") << "Not implemented daugt in get_Evt2HDM_ff_3P0.\n";
      }
    }
  }
  else{
	...
	if  (dgt==D3P0SP||dgt==D3P0SN) {
      ...
      report(ERROR,"EvtGen") << "Not implemented parent in get_Evt2HDM_ff_3P0.\n";
    }
    }
  }
...
void Evt2HDMFF::Evt2HDMFF3P2 (EvtId parent,EvtId daugt,
...
double Evt2HDMFF::EvtGetGammaji ( double z )
...
double Evt2HDMFF::EvtGetas ( double massq, double massx )
{
  double lqcd2 = 0.04;
  double nflav = 4;
  double temp = 0.6;
...
double Evt2HDMFF::EvtGetas ( double mass )
