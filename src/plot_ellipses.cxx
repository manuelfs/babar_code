...
int main(){
  ...
  // Numbers from HFLAV Summer 2018
  ...
  Results RDs_HFLAV("HFLAV aver.", 0.306, {0.013}, {0.007}, kRed, -0.20);

  Results RD_BABAR ("BABAR (HT)", 0.440, {0.058}, {0.042}, kGreen+2, -0.27);
  Results RDs_BABAR("BABAR (HT)", 0.332, {0.024}, {0.018}, kGreen+2, -0.27);
  ...
  Results RDs_LHCb("LHCb (#mu)", 0.336, {0.027}, {0.030}, kCyan-2);
  ...
  if(isWide){
    ...
    RD_HFLAV.name = "HFLAV average Summer 2018";
  ...
  if(isWide){
    minX = 0.19; maxX = 0.63; minY = 0.207; maxY = 0.52;
  }
  ...
  if(isWide){
    Results RD_HFLAV4 ("noplot", 0.407, {4.5*0.039}, {4.5*0.024}, kRed, -0.20);
    Results RDs_HFLAV4("noplot", 0.306, {4.5*0.013}, {4.5*0.007}, kRed, -0.20);
    ...
    label.DrawLatex(0.5, 0.265, "#font[62]{4#sigma}");
