...
void THDM_PDFs(int PDFindex=1){
  ...
  TString xTitle[] = {"m_{miss}^{2} (GeV^{2})", "p*_{l} (GeV)"}, yTitle[] = {"Density/(GeV^{2})","Density/(GeV)"};
  int nHis = 4, nBinPDF[2], color[] = {2,4,28,1};
  ...
  TString epsName = "public_html/THDM_PDFss_"; epsName += PDFindex; epsName += ".eps";
  can.SaveAs(epsName);
