...
bsub -q $q -o $logdir/logFit_17.log FitPdfSampleKEYS 17  66      134	  1000 300 70 100  0.4   60 110  1.7   noRot  $sample  120 140 5     $Times # Sample 17
bsub -q $q -o $logdir/logFit_18.log FitPdfSampleKEYS 18  48      187	  1000 300 70 120  0.4   60 120  1.7   noRot  $sample  120 160 5     $Times # Sample 18
...
bsub -q $q -o $logdir/logFit_25.log FitPdfSampleKEYS 25  44      354	  1000 300 100 70  1.4   20 280  -1.4  noRot  $sample   25 400 -0.2  $Times # Sample 25
bsub -q $q -o $logdir/logFit_26.log FitPdfSampleKEYS 26  67      234	  1000 300 100 70  1.4   20 280  -1.4  noRot  $sample   25 450 -0.2  $Times # Sample 26
...
bsub -q $q -o $logdir/logFit_51.log FitPdfSampleKEYS 51  62      151	  1000 300 100 50  0.4   45 200  1.4   noRot  $sample  130  90 1.4   $Times # Sample 51
bsub -q $q -o $logdir/logFit_52.log FitPdfSampleKEYS 52  60      149	  1000 300 100 35  0.4   45 200  1.4   noRot  $sample  120  90 1.4   $Times # Sample 52
bsub -q $q -o $logdir/logFit_53.log FitPdfSampleKEYS 53  79      110	  1000 300 100 50  0.4   55 200  1.4   noRot  $sample  130  90 1.4   $Times # Sample 53
...
bsub -q $q -o $logdir/logFit_58.log FitPdfSampleKEYS 58  124     69	  1000 300 120 40  0.4   45 100  1.3   noRot  $sample  130  140 4    $Times # Sample 58
...
bsub -q $q -o $logdir/logFit_33.log FitPdfSampleKEYS 33  60 160   1000 300 100 30  0.3   60 70  1.9   noRot  RAllDpipi  120 100 2 # Sample 33
bsub -q $q -o $logdir/logFit_34.log FitPdfSampleKEYS 34  50 250   1000 300 100 30  0.3   50 90  1.9   noRot  RAllDpipi  120 150 2 # Sample 34
bsub -q $q -o $logdir/logFit_35.log FitPdfSampleKEYS 35  60 160   1000 300 100 30  0.3   60 70  1.9   noRot  RAllDpipi  120 100 2 # Sample 35
bsub -q $q -o $logdir/logFit_36.log FitPdfSampleKEYS 36  80 120   1000 300 100 30  0.3   50 90  1.9   noRot  RAllDpipi  120 150 2 # Sample 36
bsub -q $q -o $logdir/logFit_37.log FitPdfSampleKEYS 37  60 220   1000 300 100 30  0.3   50 90  1.9   noRot  RAllDpipi  120 150 2 # Sample 37
bsub -q $q -o $logdir/logFit_38.log FitPdfSampleKEYS 38  70 180   1000 300 100 30  0.3   60 70  1.9   noRot  RAllDpipi  120 100 2 # Sample 38
bsub -q $q -o $logdir/logFit_39.log FitPdfSampleKEYS 39  60 220   1000 300 100 30  0.3   50 90  1.9   noRot  RAllDpipi  120 150 2 # Sample 39
bsub -q $q -o $logdir/logFit_40.log FitPdfSampleKEYS 40  70 180   1000 300 100 30  0.3   60 70  1.9   noRot  RAllDpipi  120 100 2 # Sample 40


bsub -q $q -o $logdir/logFit_33.log FitPdfSampleKEYS 33  60 160   1000 300 100 30  0.3   60 70  1.9   noRot  $sample  120 100 2 # Sample 33
bsub -q $q -o $logdir/logFit_34.log FitPdfSampleKEYS 34  50 250   1000 300 100 30  0.3   50 90  1.9   noRot  $sample  120 150 2 # Sample 34
bsub -q $q -o $logdir/logFit_35.log FitPdfSampleKEYS 35  60 160   1000 300 100 30  0.3   60 70  1.9   noRot  $sample  120 100 2 # Sample 35
bsub -q $q -o $logdir/logFit_36.log FitPdfSampleKEYS 36  80 120   1000 300 100 30  0.3   50 90  1.9   noRot  $sample  120 150 2 # Sample 36
bsub -q $q -o $logdir/logFit_37.log FitPdfSampleKEYS 37  60 220   1000 300 100 30  0.3   50 90  1.9   noRot  $sample  120 150 2 # Sample 37
bsub -q $q -o $logdir/logFit_38.log FitPdfSampleKEYS 38  70 180   1000 300 100 30  0.3   60 70  1.9   noRot  $sample  120 100 2 # Sample 38
bsub -q $q -o $logdir/logFit_39.log FitPdfSampleKEYS 39  60 220   1000 300 100 30  0.3   50 90  1.9   noRot  $sample  120 150 2 # Sample 39
bsub -q $q -o $logdir/logFit_40.log FitPdfSampleKEYS 40  70 180   1000 300 100 30  0.3   60 70  1.9   noRot  $sample  120 100 2 # Sample 40

bsub -q $q -o $logdir/logFit_33.log FitPdfSampleKEYS 33  60 200   1000 300 100 30  0.3   60 70  1.9   noRot  GenDssNR  120 160 2 # Sample 33
bsub -q $q -o $logdir/logFit_34.log FitPdfSampleKEYS 34  50 250   1000 300 100 30  0.3   50 90  1.9   noRot  GenDssNR  120 150 2 # Sample 34
bsub -q $q -o $logdir/logFit_35.log FitPdfSampleKEYS 35  60 200   1000 300 100 30  0.3   60 70  1.9   noRot  GenDssNR  120 160 2 # Sample 35
bsub -q $q -o $logdir/logFit_36.log FitPdfSampleKEYS 36  80 120   1000 300 100 30  0.3   50 90  1.9   noRot  GenDssNR  120 150 2 # Sample 36
bsub -q $q -o $logdir/logFit_37.log FitPdfSampleKEYS 37  80 190   1000 300 100 30  0.3   50 90  -1.9  noRot  GenDssNR  120 150 4 # Sample 37
bsub -q $q -o $logdir/logFit_38.log FitPdfSampleKEYS 38  80 190   1000 300 100 30  0.3   50 90  -1.9  noRot  GenDssNR  120 150 4 # Sample 38
bsub -q $q -o $logdir/logFit_39.log FitPdfSampleKEYS 39  80 190   1000 300 100 30  0.3   50 90  -1.9  noRot  GenDssNR  120 150 4 # Sample 39
bsub -q $q -o $logdir/logFit_40.log FitPdfSampleKEYS 40  80 190   1000 300 100 30  0.3   50 90  -1.9  noRot  GenDssNR  120 150 4 # Sample 40
